...
import 'connect/receive_qr_page.dart';
import 'connect/send_connect_page.dart';
...
class _SimpleHomePageState extends State<SimpleHomePage> {
  ...
  /// Connect-first: Send opens the scanner + nearby list; files are
  /// picked on the connected screen. (v3.5.0 Simple-mode flow.)
  void _onSendTap() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => const SendConnectPage()),
    );
  }
  ...
  /// Phone-to-computer entry point: same connect screen with PC-flavoured
  /// hint copy (the computer shows the QR, the phone scans it).
  void _onConnectPcTap() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => const SendConnectPage(pcMode: true)),
    );
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: Builder(builder: (context) {
                      final button = _BigActionButton(
                        ...
                        label: 'Send',
                        sublabel: _isDesktop
                            ? 'Drop files here — or click to connect'
                            : 'Scan their code or pick a device',
                        filled: true,
                        onTap: _onSendTap,
                      );
                  ...
                  Expanded(
                    child: _BigActionButton(
                      ...
                      label: 'Receive',
                      sublabel: 'Shows a code for the sender to scan',
                      filled: false,
                      onTap: _onReceiveTap,
                    ),
                  ),
                  ...
                  OutlinedButton.icon(
                    onPressed: _onConnectPcTap,
                    icon: const Icon(Icons.computer),
                    label: const Text('Connect to a computer'),
